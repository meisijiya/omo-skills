...
description: >-
  omo 适配的 Matt Pocock 工程 skill 仓库在线指南 —— 16 个采纳 skill、
...
<section class="hero">
  ...
  <p class="hero-subtitle" style="color: var(--muted);">16 个工程 / 产出 skill · 三 Agent 接力工作流 · 4 步安装即用 · 长期维护手册。</p>
  <div class="ctas">
    <a class="btn btn-primary mono" href="{{ '/skills/' | relative_url }}">→ 浏览 16 skill</a>
...
<span class="ok">→</span> 16 skill dir created
<span class="c"># 2-4. cp -r × 16 + merge prompt_append</span>
